...
* Using command "docker run --name web multicontainer", the docker image and container are run
...
* Used the command "docker run --name test-postgres -e POSTGRES_PASSWORD=password -p 5432:5432 -d database" to run the container with the name "test-postgres"
  ### Logs:
  ...
  2023-11-10 05:04:00 
  2023-11-10 05:04:00 Data page checksums are disabled.
  2023-11-10 05:04:00 
  2023-11-10 05:04:00 fixing permissions on existing directory /var/lib/postgresql/data ... ok
  2023-11-10 05:04:00 creating subdirectories ... ok
  2023-11-10 05:04:00 selecting dynamic shared memory implementation ... posix
  2023-11-10 05:04:00 selecting default max_connections ... 100
  2023-11-10 05:04:00 selecting default shared_buffers ... 128MB
  2023-11-10 05:04:00 selecting default time zone ... Etc/UTC
  2023-11-10 05:04:00 creating configuration files ... ok
  2023-11-10 05:04:01 running bootstrap script ... ok
  2023-11-10 05:04:02 performing post-bootstrap initialization ... ok
  2023-11-10 05:04:03 initdb: warning: enabling "trust" authentication for local connections
  2023-11-10 05:04:03 initdb: hint: You can change this by editing pg_hba.conf or using the option -A, or --auth-local and --auth-host, the next time you run initdb.
  2023-11-10 05:04:03 2023-11-10 00:04:03.844 UTC [1] LOG:  starting PostgreSQL 15.2 (Debian 15.2-1.pgdg110+1) on x86_64-pc-linux-gnu, compiled by gcc (Debian 10.2.1-6)      10.2.1 20210110, 64-bit
  2023-11-10 05:04:03 2023-11-10 00:04:03.845 UTC [1] LOG:  listening on IPv4 address "0.0.0.0", port 5432
  2023-11-10 05:04:03 2023-11-10 00:04:03.845 UTC [1] LOG:  listening on IPv6 address "::", port 5432
  2023-11-10 05:04:03 2023-11-10 00:04:03.857 UTC [1] LOG:  listening on Unix socket "/var/run/postgresql/.s.PGSQL.5432"
  2023-11-10 05:04:03 2023-11-10 00:04:03.874 UTC [62] LOG:  database system was shut down at 2023-11-10 00:04:03 UTC
  2023-11-10 05:04:03 2023-11-10 00:04:03.891 UTC [1] LOG:  database system is ready to accept connections
  2023-11-10 05:04:03 syncing data to disk ... ok
  2023-11-10 05:04:03 
  2023-11-10 05:04:03 
  2023-11-10 05:04:03 Success. You can now start the database server using:
  2023-11-10 05:04:03 
  2023-11-10 05:04:03     pg_ctl -D /var/lib/postgresql/data -l logfile start
  2023-11-10 05:04:03 
  2023-11-10 05:04:03 waiting for server to start....2023-11-10 00:04:03.451 UTC [48] LOG:  starting PostgreSQL 15.2 (Debian 15.2-1.pgdg110+1) on x86_64-pc-linux-gnu,        compiled by gcc (Debian 10.2.1-6) 10.2.1 20210110, 64-bit
  2023-11-10 05:04:03 2023-11-10 00:04:03.478 UTC [48] LOG:  listening on Unix socket "/var/run/postgresql/.s.PGSQL.5432"
  2023-11-10 05:04:03 2023-11-10 00:04:03.497 UTC [51] LOG:  database system was shut down at 2023-11-10 00:04:02 UTC
  2023-11-10 05:04:03 2023-11-10 00:04:03.511 UTC [48] LOG:  database system is ready to accept connections
  2023-11-10 05:04:03  done
  2023-11-10 05:04:03 server started
  2023-11-10 05:04:03 
  2023-11-10 05:04:03 /usr/local/bin/docker-entrypoint.sh: ignoring /docker-entrypoint-initdb.d/*
  2023-11-10 05:04:03 
  2023-11-10 05:04:03 waiting for server to shut down...2023-11-10 00:04:03.650 UTC [48] LOG:  received fast shutdown request
  2023-11-10 05:04:03 .2023-11-10 00:04:03.653 UTC [48] LOG:  aborting any active transactions
  2023-11-10 05:04:03 2023-11-10 00:04:03.655 UTC [48] LOG:  background worker "logical replication launcher" (PID 54) exited with exit code 1
  2023-11-10 05:04:03 2023-11-10 00:04:03.656 UTC [49] LOG:  shutting down
  2023-11-10 05:04:03 2023-11-10 00:04:03.658 UTC [49] LOG:  checkpoint starting: shutdown immediate
  2023-11-10 05:04:03 2023-11-10 00:04:03.672 UTC [49] LOG:  checkpoint complete: wrote 3 buffers (0.0%); 0 WAL file(s) added, 0 removed, 0 recycled; write=0.005 s,          sync=0.002 s, total=0.017 s; sync files=2, longest=0.001 s, average=0.001 s; distance=0 kB, estimate=0 kB
  2023-11-10 05:04:03 2023-11-10 00:04:03.677 UTC [48] LOG:  database system is shut down
  2023-11-10 05:04:03  done
  2023-11-10 05:04:03 server stopped
  2023-11-10 05:04:03 
...
* Ran the "docker compose up" command and the localhost:3000 displays the hello world message and the database server starts running too
  ### Logs:
    #### Web:
    2023-11-10 10:49:24 
...
* Modified the Dockerfile to add an additional command to generate a new prisma client and added an additional environment variable in the file to display as a message in the new page
  ### File:
  FROM node
  RUN mkdir -p /app
  WORKDIR /app
...
* Modified the Docker compose file to add the volume to store backup of database
  ### File:
version: "3.9"
services:
  web:
...
* Executed the command "docker compose build"
  ### Logs:
...
* Executed the command "docker compose up"
  ### Logs:
...
* Excecuted command "docker volume inspect db_backup" to check if the volume was created
  ### Logs:
[
    {
...
## Step 7: Scaling
* Modified the docker compose file to include port options for the service that is to be scaled:
  ### File:
version: "3.9"
services:
  web:
...
* Executed the "docker compose up --scale web=2", which used two containers to deploy the web service on ports: 3000 and 3001:
  ### Logs:
...
## Step 8: Monitoring by using Prometheus and Grafana
* Modified the docker Compose file to add prometheus as a service and the dependency of the web service on this
  ### File:
  version: "3.9"
services:
  web:
...
*  Added the yaml file for prometheus that is used in the compose file
  ### File:
  global:
  scrape_interval: 10s
scrape_configs:
